            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <p>Название товара</p>
                        <input type="text" class="form-control" name="name" placeholder="" value="<?php echo $product['name']; ?>">

                        <p>Артикул</p>
                        <input type="text" class="form-control" name="code" placeholder="" value="<?php echo $product['code']; ?>">

                        <p>Стоимость, $</p>
                        <input type="text" class="form-control" name="price" placeholder="" value="<?php echo $product['price']; ?>">
                        ...
                        <p>Производитель</p>
                        <input type="text" class="form-control" name="brand" placeholder="" value="<?php echo $product['brand']; ?>">

                        <p>Изображение товара</p>
                        <img src="<?php echo Product::getImageProduct($product['id']); ?>" width="200" height="200" alt="" />
                        ...
                        <div class="form-group">
                        <p>Заголовок SEO</p>
                        <textarea name="title" class="form-control" rows="1"><?php echo $product['title']; ?></textarea>
                        </div>
                        <div class="form-group">
                        <p>Описание SEO</p>
                        <textarea name="description_seo" class="form-control" rows="2"><?php echo $product['description_seo']; ?></textarea>
                        </div>
                        <br/><br/>
